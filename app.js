...
//lock the pieces in their place
...
let arrowRotate = document.querySelector(".fa-sync-alt")

arrowDown.addEventListener('click',() => p.moveDown());
...
arrowRotate.addEventListener("click",()=>{
  p.rotate();
  dropStart = Date.now();
